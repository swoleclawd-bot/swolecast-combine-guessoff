    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex justify-between items-center px-4 lg:px-8 py-2 lg:py-3 bg-card/50 border-b border-gray-800">
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          ...
          <span className="text-xl lg:text-3xl font-black text-primary mr-1 lg:mr-2">40</span>
          <span className="text-xs lg:text-sm uppercase tracking-widest text-gray-500 font-bold">SPEED SORT</span>
        </div>
